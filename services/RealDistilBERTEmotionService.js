...
/**
 * Location Priority Service for UrbanPulse
 ...
 */
 ...
 console.warn('Emotion analysis failed:', emotionError.message);
 ...
 console.log(`[ALGORITHM 4/4] Community Voting Score: ${voteScore.toFixed(2)}% (${complaintData.votes || 0} votes)`);
